...
const CricketBatDetails = () => {
  const bats = [
    ...
    {
      size: 'Size 6',
      title: 'Advanced Cricket Bat for Juniors (11-13 Years, 5 ft 2 in - 5 ft 4 in)',
  ...
  const { title, preciseDescription, enhancedDescription, price, image, specifications } = product;
