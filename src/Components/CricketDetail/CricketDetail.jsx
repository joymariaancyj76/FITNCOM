...
function CricketDetail() {
  ...
  return (
    <div className="product-detail-page">
      {wishlistMessage && <div className="popup-message">{wishlistMessage}</div>}
        ...
        <div className="product-info">
          ...
          <div className="rating">
            {Array.from({ length: 5 }, (_, i) =>
              i < 4.5 ? <FaStar key={i} className="star-icon filled" /> : <FaStarHalfAlt key={i} className="star-icon filled" />
            )}
          </div>
...
Purpose: Batters use the bat to hit the ball, or to avoid a run out gby touching the ground with it `}</p>
      ...
      <section className="product-specifications">
        ...
        <p><strong>Height:</strong> {specs.height || "N/A"}</p>
        <p><strong>Width:</strong> {specs.width || "N/A"}</p>
        <p><strong>Weight:</strong> {specs.weight || "N/A"}</p>
        <p><strong>Material:</strong> {specs.material || "N/A"}</p>
      </section>
