...
const CartPage = () => {
  ...
  useEffect(() => {
    const products = [
      { id: 1, name: "Product 1", price: "Rs. 1000/-", image: "product1.jpg", rating: 4.5 },
      { id: 2, name: "Product 2", price: "Rs. 1500/-", image: "product2.jpg", rating: 3.5 },
      { id: 3, name: "Product 3", price: "Rs. 2000/-", image: "product3.jpg", rating: 5 },
      { id: 4, name: "Product 4", price: "Rs. 1200/-", image: "product4.jpg", rating: 4 },
      { id: 5, name: "Product 5", price: "Rs. 1800/-", image: "product5.jpg", rating: 3.8 },
  ...
  const handleNext = () => {
    setCurrentIndex((prevIndex) => Math.min(prevIndex + 1, currentProducts.length - 1)); // Prevent going beyond last product
  };
  ...
  const cartItems = [
    {
      ...
      price: "Rs. 5000/-",
      rating: 4.5,
      description: "Willow is the only type of wood that can provide the strength and compression needed for a cricket bat.",
    },
    {
      id: 2,
    ...
    <div className="cart-page">
      <header className="cart-header">
        <nav>
          ...
          <span className={activeTab === 'address' ? 'active' : ''} onClick={() => setActiveTab('address')}>
            Address
          </span>
          <span className={activeTab === 'payment' ? 'active' : ''} onClick={() => setActiveTab('payment')}>
            Payment
          </span>
        </nav>
      </header>
