  ...
  const orders = [
    {
      ...
      itemDescription: "Willow is the only type of wood that can provide the strength and compression needed for a cricket bat. There are big differences in the performance of the two types of willow.",
      itemImage: product1,
    },
    {
      ...
      itemDescription: "Willow is the only type of wood that can provide the strength and compression needed for a cricket bat.",
